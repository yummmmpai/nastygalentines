	...
	return function(){
		...
		SenateActionWidget=function(){
			function SenateActionWidget(){
				...
				this.fetchInProgress=!1,window.jQuery?this.init():this.getJQuery()}
			return SenateActionWidget.prototype.init=function(){
				return 
				$(document).ready(this.ready)},
				SenateActionWidget.prototype.ready=function(){
					return 
					this.base=$("#senate-action-widget-div"),
					this.infoDiv=this.base.find(".senator-info"),
					this.zipInput=this.base.find("input.zip"),
					this.zipInput.on("click",this.zipPress)},
					SenateActionWidget.prototype.zipPress=document.getElementByID('#button').addEventListener("click", (function(e){
						var zip;
						if(zip=this.zipInput.val(),5===zip.length)
							return 
						zip.match(/[0-9]{5}/)?this.fetchSenators(zip):void 0}),
						SenateActionWidget.prototype.fetchSenators=function(zip){if(!this.fetchInProgress)
						return 

						this.fetchInProgress=!0,console.log("fetching"),
						...
						SenateActionWidget.prototype.parseResponse=function(resp){
							...
							for(this.fetchInProgress=!1,
								this.infoDiv.empty().removeClass("hide"),
								ref=resp.results,
								results=[],
						...
						SenateActionWidget.prototype.updateSenators=function(o){
							var p,t;
							return t=o.twitter_id?
							'<a href="https://twitter.com/'+o.twitter_id+'" target="_blank">@'+o.twitter_id+"</a><br/>":
							"",p=o.phone?o.phone+"<br/>":
							"",this.infoDiv.append('<div class="col sqs-col-6 span-6 panel"><h3>'+o.first_name+" "+o.last_name+"</h3><p>"+o.office+" <br>Washington DC 20510<br>"+t+p+"<p></div>")},
							SenateActionWidget.prototype.getJQuery=function(){
								var r,s,t;
								return r=!1,
								s=document.createElement("script"),
								s.type="text/javascript",s.src="https://code.jquery.com/jquery-2.2.4.min.js",
